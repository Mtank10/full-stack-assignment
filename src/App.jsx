...
function App() {
  ...
  return (
    <section ref={showcaseRef} className="relative bg-white py-10 sticky top-0 sm:pl-4 py-20 min-h-screen flex items-center">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        <div className="flex-1 space-y-4 sm:pl-2">
